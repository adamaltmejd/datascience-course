...
This document lives in the public course repository. Note that your hand-in of PS0 happens in a separate GitHub Classroom repository that you will be invited to.

If you need help getting your setup working, there will be `PS0` office hours on **26/3, 14:00-15:00 on Zoom**.
...
That will create your own copy of the separate `PS0` repository.

## Open the assignment repo in VS Code

The simplest route is:

1. copy the repository URL from GitHub Classroom,

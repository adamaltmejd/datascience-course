...
![](visualize_workflow.png){.r-stretch}
...
::: {.fragment}
I want to study health. Health records are a (reasonbly) accurate measure of health **care**, but a biased measure of health.
:::
...
```{=html}
<video class="stretch" src="rosling-gapminder.mp4" poster="rosling-gapminder-poster.png" autoplay loop muted playsinline controls>
...
<!-- TODO
- Add mapping as an extra, perhaps make a map using flights data to/from stockholm -->

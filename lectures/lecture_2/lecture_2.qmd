...
::: {.notes}
GitHub is not needed to use Git. You can use Git locally without ever pushing to GitHub or host your own Git remote server. But GitHub is free and makes it easy to share your work and collaborate.
:::
...
::: {.notes}
This is how software is developed. A new feature is built in a branch, then merged to main with a pull request after testing. In research, we can use it to test new data processing strategies, or to try out new analyses.
:::

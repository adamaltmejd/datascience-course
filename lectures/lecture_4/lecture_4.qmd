---
title: "Lecture 4: R Basics II: Vectors, Tables, and Tidy Thinking"
...
# Vectors {background-color="#40666e"}
...
The same is true for element-wise Boolean operators:
...
# From Vectors To Tables {background-color="#40666e"}
...
# Subsetting Tables {background-color="#40666e"}
...
# Working With Table Columns {background-color="#40666e"}
...
# Categories {background-color="#40666e"}
...
# Tidy Data {background-color="#40666e"}
...
# Basic Checks {background-color="#40666e"}
...
# Quick Inspection Plots {background-color="#40666e"}
...
## Next lecture: Independent Workflows, Debugging, and AI Support {.title-slide background-color="#40666e"}

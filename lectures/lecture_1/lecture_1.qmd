...
:::
::: {.notes}
The course is not econometrics in disguise. The value added is everything that happens before and around formal analysis.
:::
...
:::: {.columns}
::: {.column width="30%"}
![Empirical research process](workflow_diagram.svg){fig-align="center" width="100%"}
:::
...
# Reproducibility and Work Habits {background-color="#40666e"}
...
## Next lecture: Project Workflows and Version Control {.title-slide background-color="#40666e"}

...
::: notes
This is a compact mental model for reading code. Many lines can be understood as: create an object, bind it to a name, then pass it to a function that returns another object.
:::
